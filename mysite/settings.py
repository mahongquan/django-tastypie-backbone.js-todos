...
#    'django1.contrib.staticfiles.finders.DefaultStorageFinder',
)
...
#     'django1.template.loaders.eggs.Loader',
)
...
MIDDLEWARE_CLASSES = (
    ...
    #'django1.contrib.redirects.middleware.RedirectFallbackMiddleware',
)
